...
public class MinionHamcrestTest extends MinionTestBase{
    ...
    public void singleMinionTest(){
        given().accept(ContentType.JSON)
                .and().pathParam("id", 24)
                .when().get(" /minions/{id}") //In normal case, we would store this into Response response and the use one of the ways(path(), jsonPath()) to do my validation
                .then().statusCode(is(200))
                .and().contentType(ContentType.JSON)
                .assertThat().body("id", is(24),
        ...
        /**
         * hamcrest are good work readability of the code but if I need to extract one value from the json payload, for exapmle name = Julio, and then
         * I want to write a query for exapmle: Select * From employees Where first_name = "Julio";
         */
    }
