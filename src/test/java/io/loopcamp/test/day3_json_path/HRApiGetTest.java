...
public class HRApiGetTest {
    ...
    @BeforeEach
    public void setUp() {
        //RestAssured.baseURI = "http://44.204.78.14:1000/ords/hr";
        RestAssured.baseURI = ConfigurationReader.getProperty("hr.api.url");

        baseURI = ConfigurationReader.getProperty("hr.api.url"); //Since I did static import of the RestAssured class, I can directly use
